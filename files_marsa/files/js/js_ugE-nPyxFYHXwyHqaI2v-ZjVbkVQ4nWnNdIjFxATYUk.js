...
$(document).keyup(function(e) {
  ...
  $(window).ready(function () {
    ...
    //     $('#chiffre-count-2 .key-fig-title div').each(function (index) {
    //         var res = parseFloat($(this).text().replace(',','.'));
    ...
    // startCounter();
    // $("#chiffre-count-2 .key-fig-title div").each(function() {
    ...
    //     var cleanfloat;
    //     if(orig.index(',')>-1){
    //         cleanfloat = parseFloat(orig.replace(",","."));
    //         orig = cleanfloat;
    //     }
...
$(window).scroll( function(){
    ...
    $('#chiffres_cles_1').each( function(i){
