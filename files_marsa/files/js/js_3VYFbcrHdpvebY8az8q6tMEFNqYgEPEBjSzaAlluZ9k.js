...
$(document).ready(function() {
    ...
    var $bHeight = 325.6;
    var $actuHeight =  $('#infos-port').height();
    var $contHeight = $('#cont-port').height();
    var $result = $contHeight + ($actuHeight - $bHeight);

    if( $actuHeight > $bHeight  ){
        alert('ok');
    }
});
...
function startCounter() {
    if ($(window).scrollTop() > 200) {
        ...
        $('#chiffre-count-2 .key-fig .chiffres .chiffre_title div').each(function () {
            var $this = $(this);
