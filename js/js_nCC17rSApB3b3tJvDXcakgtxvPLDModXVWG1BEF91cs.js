...
$(document).ready(function() {
    ...
    // });
    var i=0;
    var top_f = document.getElementsByClassName('.niv_1');
    var sous_f = document.getElementsByClassName('.menu_footer');

    if(window.matchMedia('(max-width: 768px)').matches)
    {
       $('.colonnes_menu').each(function(){
